...
export const createProductSchema = z.object({
	...
	category: z.enum([CategoryProduct.BEBIDA, CategoryProduct.COMIDA], 'La categoría debe ser BEBIDA o COMIDA'),
...
export const updateProductSchema = z
	.object({
		...
		category: z.enum([CategoryProduct.BEBIDA, CategoryProduct.COMIDA], 'La categoría debe ser BEBIDA o COMIDA').optional(),
		image: z.string().trim().optional(),
